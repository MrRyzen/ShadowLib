...
ShadowLib is a deterministic RNG + procedural/spatial primitives library for games, **structured as a Unity UPM package at the repo root** that also builds as a plain .NET solution. It is pre-release (`0.1.0-preview.4`).
